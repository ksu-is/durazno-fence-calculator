...
class calculate():
    ...
    def __init__(self):
        self.root = Tk()
        self.root.title("Fence Estimator")
        ...
        self.window = Button(self.root, text = "Please press your material of choice, and then multiply it by the footage of your ideal fence.")
        self.window.grid(row=0, column=24, columnspan=7, pady=5)
        self.window.config(font=("Arial", 18))
        self.window.focus_set()

        # Buttons
        self.button1 = Button(self.root, text="Wood", width=5, command=lambda:self.ins('5.75'),relief=RAISED,bg='light green')
        self.button1.grid(row=1,column=0, padx=3, pady=3)
        self.button1.config(font=("Arial", 18))

        self.button2 = Button(self.root, text="6ft Metal", width=7, command=lambda:self.ins('105.20'),relief=RAISED,bg='light green')
        self.button2.grid(row=1, column=1, padx=3, pady=3)
        self.button2.config(font=("Arial", 18))

        self.button3 = Button(self.root, text="6ft Aluminum", width=7, command=lambda:self.ins('97.20'),relief=RAISED,bg='light green')
        self.button3.grid(row=1, column=2, padx=3, pady=3)
        self.button3.config(font=("Arial", 18))

        self.button1 = Button(self.root, text="Cedar", width=5, command=lambda:self.ins('7.40'),relief=RAISED,bg='light green')
        self.button1.grid(row=2,column=0, padx=3, pady=3)
        self.button1.config(font=("Arial", 18))


        self.button3 = Button(self.root, text="5ft Aluminum", width=7, command=lambda:self.ins('94.15'),relief=RAISED,bg='light green')
        self.button3.grid(row=2, column=2, padx=3, pady=3)
        self.button3.config(font=("Arial", 18))

        self.button2 = Button(self.root, text="5ft Metal", width=7, command=lambda:self.ins('100.75'),relief=RAISED,bg='light green')
        self.button2.grid(row=2, column=1, padx=3, pady=3)
        self.button2.config(font=("Arial", 18))
        
        self.button3 = Button(self.root, text="1", width=3, command=lambda:self.ins('1'),relief=RAISED,bg='light green')
        self.button3.grid(row=3, column=0, padx=3, pady=3)
        self.button3.config(font=("Arial", 18))
        
        self.button2 = Button(self.root, text="2", width=3, command=lambda:self.ins('2'),relief=RAISED,bg='light green')
        self.button2.grid(row=3, column=1, padx=3, pady=3)
        self.button2.config(font=("Arial", 18))

        self.button3 = Button(self.root, text="3", width=3, command=lambda:self.ins('3'),relief=RAISED,bg='light green')
        self.button3.grid(row=3, column=2, padx=3, pady=3)
        self.button3.config(font=("Arial", 18))

        self.button4 = Button(self.root, text="4", width=3, command=lambda:self.ins('4'),relief=RAISED,bg='light green')
        self.button4.grid(row=4, column=0, padx=3, pady=3)
        ...
        self.button5.grid(row=4, column=1, padx=3, pady=3)
        ...
        self.button6.grid(row=4, column=2, padx=3, pady=3)
        ...
        self.button7.grid(row=5, column=0, padx=3, pady=3)
        ...
        self.button8.grid(row=5, column=1, padx=3, pady=3)
        ...
        self.button9.grid(row=5, column=2, padx=3, pady=3)
        ...
        self.button_open.grid(row=6, column=1, padx=3, pady=3)
        ...
        self.button_close.grid(row=6, column=2, padx=3, pady=3)
